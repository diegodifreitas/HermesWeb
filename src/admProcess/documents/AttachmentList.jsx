...
class AttachmentList extends Component {
    ...
    add(index, item = {}) {
        if(!this.props.readOnly) {
            this.props.arrayInsert('documentForm', this.props.field, index, item)
        }
    }

    remove(index) {
        if(!this.props.readOnly && this.props.list.length > 1) {
            this.props.arrayRemove('documentForm', this.props.field, index)
        }
    }
...
export default connect(null, mapDispatchToProps)(AttachmentList)